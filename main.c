...
//
//   FILE *registerFile = fopen("registered_users.bin", "ab+");
...
//     getInput(newUser[num_Users].fullname, sizeof(newUser[num_Users].fullname));
//     flushInputBuffer();
//     printf("Enter Address: ");
//     getInput(newUser[num_Users].address, sizeof(newUser[num_Users].address));
//     printf("Enter Contact: ");
//     getInput(newUser[num_Users].number, sizeof(newUser[num_Users].number));
//     flushInputBuffer();
//     printf("Enter Email: ");
//     getInput(newUser[num_Users].email, sizeof(newUser[num_Users].email));
//     flushInputBuffer();
//     printf("Thnak you for providing your information, %s\n", newUser[num_Users].fullname);
//     printf("Now you can set your Username and Password for further process\n");
//     printf("Enter New Username: ");
//     getInput(newUser[num_Users].username, sizeof(newUser[num_Users].username));
//     flushInputBuffer();
//
...
//       getInput(newUser[num_Users].password, sizeof(newUser[num_Users].password));
//       printf("Retype the password for verification: ");
//       getInput(passwordVerification, sizeof(passwordVerification));
//
//       if (strcmp(newUser[num_Users].password, passwordVerification) == 0) {
...
//     printf("Full Name: %s\n", newUser[num_Users].fullname);
//     printf("Address: %s\n", newUser[num_Users].address);
//     printf("Contact: %s\n", newUser[num_Users].number);
//     printf("Email: %s\n", newUser[num_Users].email);
//
...
//     }
//
//     // Data is correct, proceed to write it into the file
